...
# Content: ENV GO_VERSION "1.19.4"
[System.Environment]::SetEnvironmentVariable('GO_VERSION','1.19.4')

# Content: ENV GO_SHA256 "8c23c6ae7777df883ccc2fd07a90c3ac7fab3eb7398c0e2f39c7cb27ee06517e"
[System.Environment]::SetEnvironmentVariable('GO_SHA256','ada490e188bfb57c7388da7c5eba7565390992b6496204d30e710d37755956b0')
...
# Content: ENV CODEQL_VERSION "2.10.3"
[System.Environment]::SetEnvironmentVariable('CODEQL_VERSION','2.10.3')

# Content: ENV CODEQL_HASH "46f64e21c74f41210ea3f2c433d1dc622e3eb0690b42373a73fba82122b929a1"
...
# Content: ENV CACERTS_VERSION "2023-01-10"
[System.Environment]::SetEnvironmentVariable('CACERTS_VERSION','2023-01-10')

# Content: ENV CACERTS_HASH "fb1ecd641d0a02c01bc9036d513cb658bbda62a75e246bedbc01764560a639f0"
[System.Environment]::SetEnvironmentVariable('CACERTS_HASH','fb1ecd641d0a02c01bc9036d513cb658bbda62a75e246bedbc01764560a639f0')
...
# Content: LABEL codeql_version=${CODEQL_VERSION}
# LABEL resolved: codeql_version='2.10.3'
...
# Content: COPY ./windows/install_codeql.ps1 install_codeql.ps1
Write-Host @'
Starting to copy $DockerRepoPath\.\windows\install_codeql.ps1 install_codeql.ps1 ...
'@
copy $DockerRepoPath\.\windows\install_codeql.ps1 install_codeql.ps1
Write-Host

# Content: RUN powershell -C .\install_codeql.ps1
$stopwatch = [system.diagnostics.stopwatch]::StartNew()
Write-Host @'
Starting to .\install_codeql.ps1
 ...
'@
.\install_codeql.ps1
# Restore location and reload environment in case if they were changed
...
# install ninja
# Content: COPY ./windows/install_ninja.ps1 install_ninja.ps1
Write-Host @'
Starting to copy $DockerRepoPath\.\windows\install_ninja.ps1 install_ninja.ps1 ...
'@
copy $DockerRepoPath\.\windows\install_ninja.ps1 install_ninja.ps1
Write-Host

# Content: RUN powershell -C .\install_ninja.ps1 -Version $ENV:NINJA_VERSION -Sha256 $ENV:NINJA_SHA256
$stopwatch = [system.diagnostics.stopwatch]::StartNew()
Write-Host @'
Starting to .\install_ninja.ps1 -Version $ENV:NINJA_VERSION -Sha256 $ENV:NINJA_SHA256
 ...
'@
