$SoftwareTable = @{
    ...
    "SEVENZIP_VERSION"="22.0.1";
    "SEVENZIP_SHA256"="b055fee85472921575071464a97a79540e489c1c3a14b9bdfbdbab60e17f36e4";
    ...
    "GO_VERSION"="1.19.7";
    "GO_SHA256"="2fd57332bc55f6d8c4860afa22301d0a2439ad63ba91e3d96b69c03c824df217";
