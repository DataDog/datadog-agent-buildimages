$SoftwareTable = @{
    ...
    "CACERTS_VERSION"="2026-07-16";
    "CACERTS_HASH"="3ff344e30b9b1ed2971044eabb438a08f2e2245ddb5f8ab1a3ad8b63ab4eaf91";
    "JAVA_VERSION"="17.0.8";
    ...
    "RUST_VERSION"="1.91.0";
    "DATADOG_CI_VERSION"="5.21.2";
    "DATADOG_CI_SHA256"="32d3471f6e934e1f29e735495150446d6a66b4b6fa73b8a4338a3fc758c952eb";
