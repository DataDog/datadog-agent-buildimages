$SoftwareTable = @{
    ...
    "SEVENZIP_VERSION"="22.01";
    "SEVENZIP_ZSTD_VERSION"="1.5.5-R3";
    "SEVENZIP_SHA256"="d542d78397bbed8e77c221f36cad461a0d83f1263b993a7048e81df40f403fb8";
    ...
    "GO_VERSION"="1.19.10";
    "GO_SHA256"="c749a054a5da17202113455040484893c29ebe5ab71fa89f60cdfb4561dcce8c";
