...
if [[ $arch == "aarch64" ]]; then
    ...
    CURSOR_SERVER_DIGEST="dac08c3e8ae686da30eb9002177cfb60accafc04096df29e62ffe0a379f1c10e"
    CURSOR_CLI_DIGEST="b56dadfd35fea435df001120d6579fc356ca41639535a1cf80d4c4be0cc08fb4"
else
    arch="x64"
    ...
    CURSOR_SERVER_DIGEST="6528d141f6f11f3ad078949014f3f39066f24542cd7db85b3b68bd167abffe08"
    CURSOR_CLI_DIGEST="75755476133b994201ad8cba8f08c2b38899e809884748edc19238823a5eb804"
fi
...
function install_vscode() {
    ...
    # Ugly hack to remove incompatible extensions when installing cursor
    # TODO(agent-devx): Install extensions using .vsix files instead of the extension gallery
    ...
    if [[ "${root_dir_name}" == ".cursor-server" ]]; then
        ...
        sed -i '/github.vscode-github-actions/d' /tmp/default-vscode-extensions.txt
    fi

    install-vscode-extensions /tmp/default-vscode-extensions.txt "${binary_name}-server"
    rm /tmp/default-vscode-extensions.txt
}
