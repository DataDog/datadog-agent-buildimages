...
variable "checksums_amd64" {
  ...
  default = {
    ...
    DATADOG_CI_SHA256        = "b163d332679b677410e05389700874a7e73b8fcb4d29dbc94c904637a9665b79"
...
variable "checksums_arm64" {
  ...
  default = {
    ...
    DATADOG_CI_SHA256        = "526d92541ef6990211f9da96d828394db956a3b12bdadc68a687b114f21918f7"
